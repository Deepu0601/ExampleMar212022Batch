...
public class ModifyCustomer {
	...
	private static void createCustomer()
	{
		try
		{
			...
			oBrowser.findElement(By.id("customerLightBox_descriptionField")).sendKeys("the customer from Bangalore");
	...
	private static void modifyCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\"taskListBlock\"]/div[2]/div[2]/div[1]/div[3]/div[1]")).sendKeys("The modify customer");
			Thread.sleep(2000);	
		}catch(Exception e)
		{
			e.printStackTrace();
